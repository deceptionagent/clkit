...
- (void)testInit
{
    ...
    CETemplateSeries *alpha = [[[CETemplateSeries alloc] initWithIdentifier:@"quone" values:@[ @"flarn", @"barf" ] variantTags:@[ north, south ]] autorelease];
    CETemplateSeries *bravo = [[[CETemplateSeries alloc] initWithIdentifier:@"xyzzy" values:@[ @"confound", @"delivery" ] variantTags:@[ east, west ]] autorelease];
    ...
    #define VERIFY_TEMPLATE(__template__) \
        ...
        XCTAssertEqualObjects(__template__.allSeries.firstObject.variantTags, (@[ north, south ])); \
        ...
        XCTAssertEqualObjects(__template__.allSeries.lastObject.variantTags, (@[ east, west ]));
